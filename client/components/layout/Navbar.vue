<template>
  <div>
    <nav class="bg-gray-800">
        ...
        <div class="relative flex items-center justify-between h-16">
          <div class="flex items-center px-2 lg:px-0">
            <div class="flex-shrink-0">
              <img src="/logo/logo-white.png" alt="Rimsys" class="h-8">
            </div>
            <div class="hidden lg:block lg:ml-6">
              <div class="flex space-x-4">
                <n-link
                  ...
                  :class="{'text-white bg-gray-900': $route.name === item.link, 'text-gray-300 hover:text-white hover:bg-gray-700': $route.name !== item.link}"
                >
                  {{ item.name }}
                </n-link>
              </div>
          ...
          <div class="flex lg:hidden">
            <!-- Mobile menu button -->
            <button class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-expanded="false" @click="toggleMobile">
          ...
          <div class="hidden lg:block lg:ml-4">
            <div class="flex items-center">
              ...
              <div class="ml-4 relative flex-shrink-0">
                <div v-if="$auth.user && $auth.user.photo_url">
                  <button id="user-menu" class="bg-gray-600 rounded-full flex text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" aria-haspopup="true" @click="toggleProfile">
                    <span class="sr-only">Open user menu</span>
                    <img class="h-8 w-8 rounded-full" :src="$auth.user.photo_url" alt="">
                  </button>
                </div>
                <transition
      ...
      <div v-if="mobile" v-on-clickaway="offMobile" class="lg:hidden">
...
export default {
  ...
  methods: {
    ...
    offProfile () { this.profile = false },
    onProfile () { this.profile = true },
    toggleMobile () { this.mobile = !this.mobile },
    offMobile () { this.mobile = false },
    onMobile () { this.mobile = true },
    logout () {
      this.$auth.logout()
    },
  },
